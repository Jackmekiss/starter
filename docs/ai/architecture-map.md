...
| `src/components/ui/`       | Reusable UI primitives and co-located Storybook stories.                                                                | Contains all 19 Fifteen-derived families implemented with local shadcn-style React Native APIs.                                                                                                     |
...
- UI composition uses React Native primitives, local CVA-based shadcn-style primitives, and NativeWind.
